...
C4Container
  ...
  System_Boundary(gitops, "gitops-templates Repository") {
    Container(workflows, "Reusable Workflows (.github/workflows/)", "GitHub Actions YAML", "13 reusable workflows: python-quality, python-test, rust-quality, rust-test, rust-build, rust-audit, typescript-quality, typescript-test, typescript-build, helm-lint, helm-release, terraform-validate, docker-build")
